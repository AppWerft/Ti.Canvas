...
namespace titanium {
	namespace bindings {
		...
		BindEntry* CanvasBindings::lookupGeneratedInit(const char* name, unsigned int length) {
			static BindEntry binds[] = {
				{"ti.canvas.CanvasModule", ::ti::canvas::CanvasModule::bindProxy, ::ti::canvas::CanvasModule::dispose},
				{"ti.canvas.ViewProxy", ::ti::canvas::canvas::ViewProxy::bindProxy, ::ti::canvas::canvas::ViewProxy::dispose}
			};
